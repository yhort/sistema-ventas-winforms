...
{
    public partial class Frm_Solo_letNum : Form
    {
        public Frm_Solo_letNum()
        {
            InitializeComponent();
        }
        ...
        private void txt_cant_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode ==Keys.Enter )
            {
                ...
                if (txt_nro.Text.Trim().Length ==0) { MessageBox.Show("Ingrese el correlativo", "", MessageBoxButtons.OK, MessageBoxIcon.Exclamation); txt_nro.Focus(); return; }
