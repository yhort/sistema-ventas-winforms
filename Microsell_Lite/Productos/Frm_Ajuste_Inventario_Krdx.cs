...
{
    public partial class Frm_Ajuste_Inventario_Krdx : Form
    {
        public Frm_Ajuste_Inventario_Krdx()
        {
            InitializeComponent();
        }
        ...
        private void Configurar_listView()
        {
            ...
            lis.Columns.Add("Pre Compra", 90, HorizontalAlignment.Left); //4
            lis.Columns.Add("Precio Venta 1", 90, HorizontalAlignment.Left);//3
       ...
       // async
        ...
        private void SeleccionarProducto()
        {
            ...
            Frm_Advertencia ver = new Frm_Advertencia();
            RN_Productos obj = new RN_Productos();
            Frm_Add_Cantidad_Stock canti = new Frm_Add_Cantidad_Stock();
            ...
            else
            {
                ...
                fil.Show();
                canti.Lbl_stockActual.Text = stockProd.ToString();
                canti.lbl_precompra.Text = preCompra1.ToString();
                canti.ShowDialog();
                fil.Hide();
                ...
                if(canti.Tag.ToString() == "A")
                {
                    ...
                    double importexx = Convert.ToDouble(canti.lbl_Importeq.Text);
                    string cantiDiferencia = canti.lbl_dife.Text;

                    xcanti = Convert.ToDouble(canti.txt_cant.Text);
                    obj.RN_Igualar_Stock_Producto(idprod, xcanti);

                    Registrar_MovimientoKardex(idprod, xcanti, cantiDiferencia, importexx);
