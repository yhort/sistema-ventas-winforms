...
{
    public partial class Frm_Crear_Ventas_conGR : Form
    {
        public Frm_Crear_Ventas_conGR()
        {
            InitializeComponent();
        }
        ...
        private void Configurar_listView()
        {
            ...
            lis.Columns.Add("ID GR", 110, HorizontalAlignment.Left); //0
            lis.Columns.Add("Nombre del Cliente", 400, HorizontalAlignment.Left);  //1
            lis.Columns.Add("cantidad", 0, HorizontalAlignment.Left);  //2
            ...
            lis.Columns.Add("Und", 0, HorizontalAlignment.Center);  //6
        ...
        private void Configura_ListView_Pdet()
        {
            ...
            lis.Columns.Add("Descripcion producto", 270, HorizontalAlignment.Left);  //1
            lis.Columns.Add("cantidad", 50, HorizontalAlignment.Center);  //2
            lis.Columns.Add("precio Vnta", 60, HorizontalAlignment.Right);  //3
            ...
            lis.Columns.Add("Unidad de Medida", 100, HorizontalAlignment.Center);
        }

        //private void Config_ListView_Docs()
        //{
        //    {
        //        var withBlock = lsv_Det;
        ...
        //        withBlock.Columns.Add("Nro Guia", 110, HorizontalAlignment.Left); // 3
        //        //withBlock.Columns.Add("T Doc", 50, HorizontalAlignment.Left); // 4
        //        withBlock.Columns.Add("Nro Ruc", 100, HorizontalAlignment.Left); // 5 el precio del Producto con Igv
            ...
            {
                {
                    ...
                    foreach (DataRow Registros in xdata.Rows)
                    {
                        ...
                        //xcant = Convert.ToInt32( Registros["Cantidad"].ToString());
                        ...
                        else
                        {
                            ...
                            xNroDoc = Registros["Id_DocComp"].ToString();
                            withBlock1.SubItems.Add(Registros["NOMBRE"].ToString()); // 
                            
                            withBlock1.SubItems.Add(xNroDoc.Trim()); // 14
                            xNroDni = Registros["RUC"].ToString();
                            ...
                            withBlock1.SubItems.Add(Registros["SubTotal_ingre"].ToString());
                            withBlock1.SubItems.Add(Registros["Total_Ingre"].ToString());                                                    
        ...
        private void buscar_Productos(string valor)
        {
            ...
            try
            {
                ...
                {
                    //busqueda exacta: devuelve un solo reg
                    ...
                    if (xstock > 0)
                    {
                        ...
                        //cant.lbl_und.Text = und; opcional para colocar decimanles
                        cant.ShowDialog();
                        fil.Hide();
                        ...
                        if(cant.Tag.ToString()== "A")
                        {
                            ...
                            //Agregar_Productos_alCarrito(xidprod, xproducto, cantidad, PreVenta, PreVenta,und /*"und"*/ , "Producto", UtiliUnitaria, "Gravado", "NIU");
                ...
                {
                    MessageBox.Show("El Producto no Existe!", "ADveretencia", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                    return;
                }
            }
            catch (Exception ex)
        ...
        private void Bucar_Documento_paraReimprimir(List<string> nroDocs)
        {
                ...
                foreach (string nroDoc in nroDocs)
                {
                    ...
                    if (dato.Rows.Count > 0)
                    {
                        ...
                        foreach (DataRow xitem in dato.Rows)
                        {
                            ...
                            xlist.SubItems.Add(xitem["UtilidadUnit"].ToString());
                            xlist.SubItems.Add(xafecto);
                            xlist.SubItems.Add("0.00");
                            xlist.SubItems.Add("0.00");
                            xlist.SubItems.Add("0.00");
                            //xlist.SubItems.Add(xitem["###0.000000"].ToString());
                            //xlist.SubItems.Add(xitem["###0.000000"].ToString());
                            //xlist.SubItems.Add(xitem["###0.000000"].ToString());
                        }
                        Calcular();
        ...
        private void EnviarDocumento_dePrueba_Sunat()
        {
            ...
            try
            {
                ...
                objCPE.TIPO_DOCUMENTO_EMPRESA = "6";
                objCPE.NOMBRE_COMERCIAL_EMPRESA = Lbl_EmpresaEmisor.Text.Trim();
                objCPE.CODIGO_UBIGEO_EMPRESA = "150101"; // -   //san miguel 150136
                objCPE.DIRECCION_EMPRESA = Lbl_DireccionEmpresa.Text.Trim();
                objCPE.DEPARTAMENTO_EMPRESA = "Lima";
                objCPE.PROVINCIA_EMPRESA = "Lima";
                objCPE.DISTRITO_EMPRESA = "Lima";
        ...
        private void Consultar_Doc_delRangoFechas(DateTime fecha, DateTime fecha2)
        {
            DataTable data = new DataTable();
            RN_Ingreso_Compra obj = new RN_Ingreso_Compra();


            data = obj.RN_Compras_RangoFechas(fecha, fecha2);
            if (data.Rows.Count > 0)
            {
                //llena(data);
            }
        ...
        private void Dtp_FechaDoc2_ValueChanged(object sender, EventArgs e)
        {
