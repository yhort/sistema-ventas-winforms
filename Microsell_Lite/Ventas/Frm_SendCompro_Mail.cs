...
{
    public partial class Frm_SendCompro_Mail : Form
    {
        public Frm_SendCompro_Mail()
        {
            InitializeComponent();
        }
        private void Frm_SendCompro_Mail_Load(object sender, EventArgs e)
        {
            Leer_Dato_Empresa();
            lbl_msm.Text = "";
        ...
        {
            Frm_Loading_SendMail load = new Frm_Loading_SendMail();
            ...
            try
            {
                ...
                //load.Show();
                load.Lbl_TituPrinci.Text = "Espere, Estamos enviando el Correo";
                load.ShowDialog();
                load.Close();
                load.Lbl_TituPrinci.Refresh();
                //load.Hide();


                // continuar para colocar el lkoadinfg
                /*
                ...
                */
                ...
                if (enviado == true)
                {
                    load.PictureBox1.Visible = false;
                    load.Lbl_TituPrinci.Text = "Completado";
                    load.ShowDialog();
                ...
                else
                {
                    ...
                    {
                        load.PictureBox1.Visible = false;
                        load.Lbl_TituPrinci.Text = "Completado, correo enviado";
                        load.ShowDialog();
