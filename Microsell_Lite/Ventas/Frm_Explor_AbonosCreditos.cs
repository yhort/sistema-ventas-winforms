...
{
    public partial class Frm_Explor_AbonosCreditos : Form
    {
        public Frm_Explor_AbonosCreditos()
        {
            InitializeComponent();
           
        }
        private void Frm_Explor_AbonosCreditos_Load(object sender, EventArgs e)
        ...
        private void Configurar_listView()
        {
            ...
            lis.Columns.Add("item", 100, HorizontalAlignment.Left); //1
            lis.Columns.Add("A cuenta", 90, HorizontalAlignment.Left); //3
            lis.Columns.Add("Saldo Pdnte", 90, HorizontalAlignment.Left);//4
            lis.Columns.Add("Fecha Emi", 100, HorizontalAlignment.Left); //1
            lis.Columns.Add("Fecha Abono", 100, HorizontalAlignment.Left); //2
        ...
        private void buscar_Docu_Creditos(string valorxxx)
        {
            //RN_Credito obj = new RN_Credito();
            ...
            DataTable dato = new DataTable();
                ...
                dato = obj.RN_Buscar_KardexDetalle_Abono_por_Doc(valorxxx);
                if (dato.Rows.Count > 0)
                {
                    Llenar_Listview(dato);
                }
        ...
        private void buscar_doc_creditos_pordia(DateTime fechax)
        {
            ...
            dato = obj.RN_Cargar_DetalleKardexCredito_delDia(fechax);
            if (dato.Rows.Count > 0)
            {
                Llenar_Listview(dato);
            }
