...
{
    public partial class Frm_Print_Informe_Almacen : Form
    {
        public Frm_Print_Informe_Almacen()
        {
            InitializeComponent();
        }
        ...
        {
            if (tipoDoc == "salidaalma")
            {
                Imprimir_Informe_SalidaAlmacen(NroDoc);
            }
            ...
            {
                Imprimir_ReporteCaja(NroDoc);
            }
            if (tipoDoc.Trim() == "venta_delmes")
            {
                Imprimir_ReporteGeneral_Ventas_xMes();
            }
            if (tipoDoc.Trim() == "kardx_valori")
            {
                Imprimir_Kardex_Valorizado();
            }
            if (tipoDoc.Trim() == "Doc Transportista")
            {
                Imprimir_Informe_GuiaR_Rem(NroDoc);
            }
            //if(tipoDoc.Trim() == "Doc Transportista" && modalidad_traslado.Trim() == "privado")
            //{
            //    Imprimir_Informe_GuiaR_Rem_Privado(NroDoc);
            //}
        ...
        private void Imprimir_Informe_GuiaR_Rem(string idDoc)
        {
        ...
        private void Imprimir_Informe_GuiaR_Rem_Impor_TextilLucero(string idDoc)
        {
            BD_GuiaRemision obj = new BD_GuiaRemision();
            DataTable dato = new DataTable();
            dato = obj.BD_Buscador_DocumentoGR_Detalle_porID(idDoc.Trim());
        ...
        private void Imprimir_Informe_GuiaR_Rem_Privado(string idDoc)
        {
            BD_GuiaRemision obj = new BD_GuiaRemision();
            DataTable dato = new DataTable();
