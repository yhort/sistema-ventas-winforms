...
using Microsell_Lite.Consultas;
//using Microsoft.Office.Interop.Excel;

//using Microsoft.Office.Interop.Excel;


namespace Microsell_Lite.Consultas
{
    public partial class Frm_Explor_Documento_Import : Form
    {
        public Frm_Explor_Documento_Import()
        {
            InitializeComponent();
        ...
        private void Configurar_listView()
        {
            ...
            lis.Columns.Add("Fecha Emi", 170, HorizontalAlignment.Left); //1
            lis.Columns.Add("Nombre del Cliente", 350, HorizontalAlignment.Left); //2
            lis.Columns.Add("DNI ó RUC", 90, HorizontalAlignment.Left);//3
            lis.Columns.Add("Tipo Doc", 90, HorizontalAlignment.Left); //4 
            //lis.Columns.Add("Nro Pedido", 90, HorizontalAlignment.Left);//5
            lis.Columns.Add("Tipo Pago", 90, HorizontalAlignment.Left);//6
